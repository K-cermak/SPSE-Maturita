...
- Pokud budeš mít ale už jako téma něco s Arduinem, pravděpodobně budeš mít možnost výběru mezi JEL / KAS / KOU (pokud budete brát v úvahu, že RES neumí s Arduinem).
...
- Je fakt dobré si zvolit něco, co tě zajímá a bude tě bavit.
...
- Pokud si chceš vzít e-shop (jako to udělá 2/3 třídy) - fakt se zamysli nad tím, jestli si nemůžeš vzít něco trochu inteligentnějšího. Většina projektů pak nestojí za nic a sice i když dostanou slušnou známku, ten kód je v praxi nenasaditelný.
    ...
    - Prakticky nikdo neintegruje do maturitních e-shopu platební bránu či rozhraní od dopravců (výběr pobočky pro vyzvednutí od Zásilkovny).
    ...
    - U jednoho e-shopu jsem našel zranitelnost, kdy jsem mohl stáhnotu libovolnou vygenerovanou fakturu (tedy i jiného zákazníka). Toto je u běžně používaných e-shopových systémů vysoce napravděpoboné, protože jsou velmi pečlivě testovány a odladěny.
...
- Fakt se zamysli, jestli není lepší nápad dělat něco jiného než e-shop, co třeba je potenciálně nasaditelné v praxi. Věř, že průměrný maturitní e-shop má k nasaditelnému a funkčnímu e-shopu hodně daleko. 
...
- Doporučuji psát věci dost obecně a nechávat si prostor na případné jiné řešení. Nepiš tam to, co sice chceš udělat, ale nejsi si jistý, zda to stihneš udělat.
    - *Zpracování odeslaných dat na serveru denních statistik a využití těchto dat pro vykreslování dat* -> stačí napsat například jen *Zpracování odeslaných dat na serveru*.
...
- Sice nějaké mám, ale nechci sdílet cizí materiály bez povolení. Svojí bych rád nasdílel, ale jsou tam nějaké dost citlivé data, takže se spíše zeptejte svého vyučujícího.
- DUS má na i3 template pro dokumentaci ve Wordu, doporučuji se podle něho řídit.

<br>

### Můžu používat frameworky či různé knihovny?
- Ano, můžeš používat jakékoliv dostupné knihovny.
...
- KOU taktéž pravidelně dělá screenshoty všech stránek a tvoje nahrané soubory k datumu odezvdání archivuje, takže i nějaký PHP file uploader půjde odhalit. 
...
- Součástí ústních zkoušek je i obhajoba maturitního projektu. Za obhajobu můžeš získat až 20 bodů (10 + 10) a hlavně bys měl ukázat to, jak tvůj projekt funguje.
